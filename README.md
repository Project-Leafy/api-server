...
> 반려식물 성장 관리 및 AI 진단/추천 서비스 'Leafy'의 백엔드 레пози토리입니다.

## 1. 📜 프로젝트 개요

[cite_start]'Leafy'는 식물 입문자들이 겪는 식별의 어려움과 관리의 막막함을 AI 기술로 해결하는 모바일 앱입니다. [cite: 29, 30] [cite_start]사용자는 사진 한 장으로 식물을 식별하고, AI 진단을 받으며 [cite: 32][cite_start], 개인화된 성장 일지를 바탕으로 스마트한 관리 알림을 받아 식물과 함께 성장하는 즐거움을 경험할 수 있습니다. [cite: 34, 35]
